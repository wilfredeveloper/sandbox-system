...
class LoadTester:
    def __init__(self, server_url="http://spinwish.tech:2205", num_workers=10, requests_per_worker=10):
...
if __name__ == '__main__':
    ...
    server_url = "http://spinwish.tech:2205"
    workers = 10
    num_requests = 10
    ...
    if '--help' in sys.argv or '-h' in sys.argv:
        ...
        print("\nOptions:")
        print("  --url URL          Server URL (default: http://spinwish.tech:2205)")
        ...
        print("  python load_test.py --url http://spinwish.tech:8000 --workers 50")
        sys.exit(0)
